...
const list = ['DIV', 'VAR', 'LET', 'CONST', 'PREVENT', 'DEFAULT', 'NUN', 'UNDEFINED',
    'SPAN', 'WORD', 'ADD', 'REMOVE', 'SETTIMEOUT', 'LIVE', 'SERVER', ' INDEX','HTML',
    'CSS', 'JAVASCRIPT', 'PHP', 'BOOTCAMP', 'SCSS', 'ACCOUNT', 'ACCURATE', 'ACRES',
    'ACROSS', 'ACT', 'ACTION', 'ACTIVE', 'ACTIVITY', 'MEXANIZATSIALASHTIRILMAGANLIGIDANMKIM',
    'ACTUAL', 'ACTUALLY', 'ADD', 'ADDITION', 'ADDITIONAL', 'ADJECTIVE', 'ADULT',
    'ADVENTURE', 'DENA' , 'MOHITO' , 'PEPSI' , 'COCACOLA' , 'FANTA' , 'REDBULL' ,
